...
namespace MvcCrud.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Guncel(int id, ProductsModel pm)
        {
            ...
            {
                Products seccategory = db.Products.Find(id);
                seccategory.ProductName = pm.Products.ProductName;
                seccategory.SupplierID = pm.Products.SupplierID;
                seccategory.CategoryID = pm.Products.CategoryID;
                seccategory.UnitPrice = pm.Products.UnitPrice;
                db.SaveChanges();
            ...
            //db.Entry(pm.Products).State = System.Data.Entity.EntityState.Modified;//bu şekildede güncelleme işlemi yapılabilir
            //db.SaveChanges();
            //return RedirectToAction("Liste");
        }
